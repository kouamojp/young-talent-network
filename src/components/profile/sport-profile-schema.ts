...
export const SPORT_SCHEMAS: SportSchema[] = [
  {
    ...
    fields: [
      ...
      { key: 'strengths_notes', label: { en: 'Strengths — notes', fr: 'Points forts — notes', ru: 'Сильные — примечания' }, type: 'textarea' },
      { key: 'weaknesses', label: { en: 'Weaknesses', fr: 'Points faibles', ru: 'Слабые качества' }, type: 'multiselect', options: [
        { value: 'block', label: { en: 'Block', fr: 'Bloc', ru: 'Блок' } },
        { value: 'reception', label: { en: 'Reception', fr: 'Réception', ru: 'Приём' } },
        { value: 'serve', label: { en: 'Serve', fr: 'Service', ru: 'Подача' } },
        { value: 'attack1', label: { en: '1st-tempo attack', fr: 'Attaque 1er temps', ru: 'Первый темп' } },
      ...
      { key: 'weaknesses_notes', label: { en: 'Weaknesses — notes', fr: 'Points faibles — notes', ru: 'Слабые — примечания' }, type: 'textarea' },
  ...
  {
    id: 'football',
    label: { en: 'Football (Soccer)', fr: 'Football', ru: 'Футбол' },
    fields: [
      ...PHYSICAL,
      { key: 'strong_foot', label: { en: 'Strong foot', fr: 'Pied fort', ru: 'Рабочая нога' }, type: 'select', options: [
        { value: 'left', label: { en: 'Left', fr: 'Gauche', ru: 'Левая' } },
        { value: 'right', label: { en: 'Right', fr: 'Droit', ru: 'Правая' } },
        { value: 'both', label: { en: 'Both', fr: 'Deux pieds', ru: 'Двуногий' } },
      ]},
      { key: 'position', label: { en: 'Position', fr: 'Poste', ru: 'Позиция на поле' }, type: 'select', options: [
        { value: 'gk', label: { en: 'Goalkeeper', fr: 'Gardien', ru: 'Вратарь' } },
        { value: 'lb', label: { en: 'Left back', fr: 'Latéral gauche', ru: 'Левый защитник' } },
        { value: 'rb', label: { en: 'Right back', fr: 'Latéral droit', ru: 'Правый защитник' } },
        { value: 'cb', label: { en: 'Center back', fr: 'Défenseur central', ru: 'Центральный защитник' } },
        { value: 'dm', label: { en: 'Defensive midfielder', fr: 'Milieu défensif', ru: 'Опорный полузащитник' } },
        { value: 'cm', label: { en: 'Central midfielder', fr: 'Milieu central', ru: 'Центральный полузащитник' } },
        { value: 'am', label: { en: 'Attacking midfielder', fr: 'Milieu offensif', ru: 'Центр. атакующий п/з' } },
        { value: 'lm', label: { en: 'Left midfielder', fr: 'Milieu gauche', ru: 'Левый полузащитник' } },
        { value: 'rm', label: { en: 'Right midfielder', fr: 'Milieu droit', ru: 'Правый полузащитник' } },
        { value: 'lw', label: { en: 'Left winger', fr: 'Ailier gauche', ru: 'Левый ат. нападающий' } },
        { value: 'rw', label: { en: 'Right winger', fr: 'Ailier droit', ru: 'Правый ат. нападающий' } },
        { value: 'st', label: { en: 'Striker', fr: 'Avant-centre', ru: 'Центральный нападающий' } },
      ]},
      { key: 'rank', label: { en: 'Rank', fr: 'Catégorie', ru: 'Разряд' }, type: 'select', options: RANK_OPTIONS },
      { key: 'strengths', label: { en: 'Strengths', fr: 'Points forts', ru: 'Сильные качества' }, type: 'textarea' },
      { key: 'weaknesses', label: { en: 'Weaknesses', fr: 'Points faibles', ru: 'Слабые качества' }, type: 'textarea' },
      { key: 'career', label: { en: 'Career (team, year)', fr: 'Carrière (équipe, année)', ru: 'Игровая карьера (команда, год)' }, type: 'textarea' },
      { key: 'stats_matches', label: { en: 'Matches played', fr: 'Matchs joués', ru: 'Кол-во матчей' }, type: 'number' },
      { key: 'stats_goals', label: { en: 'Goals', fr: 'Buts', ru: 'Кол-во голов' }, type: 'number' },
      { key: 'leagues', label: { en: 'League experience', fr: 'Expérience en ligue', ru: 'Опыт лиг' }, type: 'multiselect', options: LEAGUE_OPTIONS },
      ...COMMON_TAIL,
    ],
  },
  {
    id: 'hockey',
    label: { en: 'Ice Hockey', fr: 'Hockey sur glace', ru: 'Хоккей' },
    fields: [
      ...PHYSICAL,
      { key: 'position', label: { en: 'Position', fr: 'Poste', ru: 'Позиция на поле' }, type: 'select', options: [
        { value: 'gk', label: { en: 'Goalie', fr: 'Gardien', ru: 'Вратарь' } },
        { value: 'ld', label: { en: 'Left defenseman', fr: 'Défenseur gauche', ru: 'Левый защитник' } },
        { value: 'rd', label: { en: 'Right defenseman', fr: 'Défenseur droit', ru: 'Правый защитник' } },
        { value: 'lw', label: { en: 'Left wing', fr: 'Ailier gauche', ru: 'Левый нападающий' } },
        { value: 'rw', label: { en: 'Right wing', fr: 'Ailier droit', ru: 'Правый нападающий' } },
        { value: 'c',  label: { en: 'Center', fr: 'Centre', ru: 'Центральный нападающий' } },
      ]},
      { key: 'grip', label: { en: 'Stick grip', fr: 'Prise de crosse', ru: 'Хват' }, type: 'select', options: [
        { value: 'left', label: { en: 'Left', fr: 'Gauche', ru: 'Левый' } },
        { value: 'right', label: { en: 'Right', fr: 'Droite', ru: 'Правый' } },
      ]},
      { key: 'rank', label: { en: 'Rank', fr: 'Catégorie', ru: 'Разряд' }, type: 'select', options: RANK_OPTIONS },
      { key: 'strengths', label: { en: 'Strengths', fr: 'Points forts', ru: 'Сильные качества' }, type: 'textarea' },
      { key: 'weaknesses', label: { en: 'Weaknesses', fr: 'Points faibles', ru: 'Слабые качества' }, type: 'textarea' },
      { key: 'career', label: { en: 'Career (team, year)', fr: 'Carrière (équipe, année)', ru: 'Игровая карьера (команда, год)' }, type: 'textarea' },
      { key: 'stats_matches', label: { en: 'Matches played', fr: 'Matchs joués', ru: 'Кол-во матчей' }, type: 'number' },
      { key: 'stats_points', label: { en: 'Points', fr: 'Points', ru: 'Очки' }, type: 'number' },
      ...COMMON_TAIL,
    ],
  },
  {
    id: 'tennis',
    label: { en: 'Tennis', fr: 'Tennis', ru: 'Теннис' },
    fields: [
      ...PHYSICAL,
      { key: 'strong_hand', label: { en: 'Dominant hand', fr: 'Main forte', ru: 'Рабочая рука' }, type: 'select', options: HAND_OPTS },
      { key: 'backhand', label: { en: 'Backhand', fr: 'Revers', ru: 'Удар слева' }, type: 'select', options: [
        { value: 'one', label: { en: 'One-handed', fr: 'À une main', ru: 'Одной рукой' } },
        { value: 'two', label: { en: 'Two-handed', fr: 'À deux mains', ru: 'Двумя руками' } },
      ]},
      { key: 'play_style', label: { en: 'Playing style', fr: 'Style de jeu', ru: 'Стиль игры' }, type: 'select', options: [
        { value: 'serve_volley', label: { en: 'Serve-and-volleyer', fr: 'Service-volée', ru: 'Сеточник' } },
        { value: 'counter', label: { en: 'Counter-puncher (passive baseliner)', fr: 'Contre-attaquant', ru: 'Игрок контрудара' } },
        { value: 'aggressive_baseline', label: { en: 'Aggressive baseliner', fr: 'Attaquant de fond de court', ru: 'Агрессивный игрок с задней линии' } },
        { value: 'all_court', label: { en: 'All-courter', fr: 'Joueur complet', ru: 'Универсал' } },
      ]},
      { key: 'rank', label: { en: 'Rank', fr: 'Catégorie', ru: 'Разряд' }, type: 'select', options: RANK_OPTIONS },
      { key: 'strengths', label: { en: 'Strengths', fr: 'Points forts', ru: 'Сильные качества' }, type: 'textarea' },
      { key: 'weaknesses', label: { en: 'Weaknesses', fr: 'Points faibles', ru: 'Слабые качества' }, type: 'textarea' },
      { key: 'stats_matches', label: { en: 'Matches played', fr: 'Matchs joués', ru: 'Кол-во матчей' }, type: 'number' },
      { key: 'stats_wins', label: { en: 'Wins', fr: 'Victoires', ru: 'Победы' }, type: 'number' },
      { key: 'stats_losses', label: { en: 'Losses', fr: 'Défaites', ru: 'Поражения' }, type: 'number' },
      ...COMMON_TAIL,
    ],
  },
  {
    id: 'boxing',
    label: { en: 'Boxing', fr: 'Boxe', ru: 'Бокс' },
    fields: [
      ...PHYSICAL,
      { key: 'reach_cm', label: { en: 'Reach (cm)', fr: 'Allonge (cm)', ru: 'Размах рук (см)' }, type: 'number' },
      { key: 'stance', label: { en: 'Stance', fr: 'Garde', ru: 'Стойка' }, type: 'select', options: [
        { value: 'orthodox', label: { en: 'Orthodox', fr: 'Droitière', ru: 'Левосторонняя' } },
        { value: 'southpaw', label: { en: 'Southpaw', fr: 'Gauchère', ru: 'Правосторонняя' } },
        { value: 'frontal', label: { en: 'Frontal', fr: 'Frontale', ru: 'Фронтальная' } },
      ]},
      { key: 'style', label: { en: 'Style', fr: 'Style', ru: 'Стиль' }, type: 'select', options: [
        { value: 'outfighter', label: { en: 'Out-fighter', fr: 'Out-fighter', ru: 'Аутфайтер' } },
        { value: 'puncher', label: { en: 'Puncher', fr: 'Puncher', ru: 'Панчер' } },
        { value: 'slugger', label: { en: 'Slugger / Brawler', fr: 'Slugger / Brawler', ru: 'Слаггер / Браулер' } },
        { value: 'swarmer', label: { en: 'Swarmer / In-fighter', fr: 'Swarmer / In-fighter', ru: 'Свормер / Инфайтер' } },
      ]},
      { key: 'rank', label: { en: 'Rank', fr: 'Catégorie', ru: 'Разряд' }, type: 'select', options: RANK_OPTIONS },
      { key: 'strengths', label: { en: 'Strengths', fr: 'Points forts', ru: 'Сильные качества' }, type: 'textarea' },
      { key: 'weaknesses', label: { en: 'Weaknesses', fr: 'Points faibles', ru: 'Слабые качества' }, type: 'textarea' },
      { key: 'fights', label: { en: 'Total fights', fr: 'Combats', ru: 'Кол-во боёв' }, type: 'number' },
      { key: 'wins', label: { en: 'Wins', fr: 'Victoires', ru: 'Победы' }, type: 'number' },
      { key: 'draws', label: { en: 'Draws', fr: 'Nuls', ru: 'Ничьи' }, type: 'number' },
      { key: 'losses', label: { en: 'Losses', fr: 'Défaites', ru: 'Поражения' }, type: 'number' },
      ...COMMON_TAIL,
    ],
  },
  {
    id: 'handball',
    label: { en: 'Handball', fr: 'Handball', ru: 'Гандбол' },
    fields: [
      ...PHYSICAL,
      { key: 'position', label: { en: 'Position', fr: 'Poste', ru: 'Позиция на поле' }, type: 'select', options: [
        { value: 'gk', label: { en: 'Goalkeeper', fr: 'Gardien', ru: 'Вратарь' } },
        { value: 'center', label: { en: 'Centre back', fr: 'Demi-centre', ru: 'Центральный игровой' } },
        { value: 'back', label: { en: 'Left/Right back', fr: 'Arrière G/D', ru: 'Боковой / полусредний' } },
        { value: 'wing', label: { en: 'Winger', fr: 'Ailier', ru: 'Крайний' } },
        { value: 'pivot', label: { en: 'Pivot / Line player', fr: 'Pivot', ru: 'Линейный / оборотный' } },
      ]},
      { key: 'throw_hand', label: { en: 'Throwing hand', fr: 'Main de tir', ru: 'Бросковая рука' }, type: 'select', options: HAND_OPTS },
      { key: 'rank', label: { en: 'Rank', fr: 'Catégorie', ru: 'Разряд' }, type: 'select', options: RANK_OPTIONS },
      { key: 'strengths', label: { en: 'Strengths', fr: 'Points forts', ru: 'Сильные качества' }, type: 'textarea' },
      { key: 'weaknesses', label: { en: 'Weaknesses', fr: 'Points faibles', ru: 'Слабые качества' }, type: 'textarea' },
      { key: 'career', label: { en: 'Career (team, year)', fr: 'Carrière (équipe, année)', ru: 'Игровая карьера (команда, год)' }, type: 'textarea' },
