...
const CategorySection: React.FC = () => {
  ...
  const categories = [
    {
      title: "Sports",
      description: "For athletes and sports performers looking to advance their career and find opportunities worldwide.",
    ...
    {
      title: "Music",
      description: "For vocalists, instrumentalists, composers, and all musical talents seeking recognition.",
    ...
    {
      title: "Dance",
      description: "For dancers of all styles looking to perform, compete, and collaborate on bigger stages.",
    ...
    {
      title: "Acting",
      description: "For performers seeking roles in theater, film, television and other media.",
    ...
    {
      title: "Innovation",
      description: "For inventors, entrepreneurs, and creative minds with groundbreaking ideas.",
    ...
    {
      title: "Visual Arts",
      description: "For painters, sculptors, photographers, and digital artists to showcase their portfolio.",
      ...
      <div className="container px-4 mx-auto">
        <div ref={sectionRef} className="max-w-3xl mx-auto text-center mb-16 stagger-animation">
          <div className="inline-block px-3 py-1 mb-4 bg-black/5 rounded-full">
            <span className="text-xs tracking-wide font-medium">Explore Categories</span>
          </div>
          ...
          <p className="text-lg text-black/70">
            Y&T supports talents across multiple disciplines, connecting you with the 
            right audience, mentors, and opportunities in your specific field.
          </p>
        </div>
