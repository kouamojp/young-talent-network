...
const sampleOrganizations = [
  {
    ...
    customDescription: 'Specializing in breakthrough talent discovery and career management.',
    rating: 4.8,
    verified: true,
...
const OrganizationDiscovery: React.FC = () => {
  ...
  const filteredOrganizations = sampleOrganizations.filter(org => {
    ...
    const matchesFilter = selectedFilter === 'all' || 
                         (selectedFilter === 'recent' && org.recentlyAdded) ||
                         (selectedFilter === 'verified' && org.verified);
    
    return matchesSearch && matchesFilter;
  });

  const organizationCount = filteredOrganizations.length;
        ...
        <CardContent>
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <Input
                placeholder="Search organizations, agencies, companies..."
                value={searchTerm}
